...
public class Email extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9109945701936585613L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Email\",\"namespace\":\"bri.avro.kafka.flatten.dto\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Primary, Secondary\"},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Client email address\"}]}");
   ...
   */
  public Email(java.lang.String type, java.lang.String email) {
    this.type = type;
    this.email = email;
  }
   ...
   */
  public static bri.avro.kafka.flatten.dto.Email.Builder newBuilder() {
    return new bri.avro.kafka.flatten.dto.Email.Builder();
  }
   ...
   * @return A new Email RecordBuilder
   */
  public static bri.avro.kafka.flatten.dto.Email.Builder newBuilder(bri.avro.kafka.flatten.dto.Email.Builder other) {
    if (other == null) {
      return new bri.avro.kafka.flatten.dto.Email.Builder();
    } else {
      return new bri.avro.kafka.flatten.dto.Email.Builder(other);
    }
  }
   ...
   * @return A new Email RecordBuilder
   */
  public static bri.avro.kafka.flatten.dto.Email.Builder newBuilder(bri.avro.kafka.flatten.dto.Email other) {
    if (other == null) {
      return new bri.avro.kafka.flatten.dto.Email.Builder();
    } else {
      return new bri.avro.kafka.flatten.dto.Email.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Email>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(bri.avro.kafka.flatten.dto.Email.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(bri.avro.kafka.flatten.dto.Email other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
    ...
    /**
      ...
      * @return This builder.
      */
    public bri.avro.kafka.flatten.dto.Email.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public bri.avro.kafka.flatten.dto.Email.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public bri.avro.kafka.flatten.dto.Email.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public bri.avro.kafka.flatten.dto.Email.Builder clearEmail() {
      email = null;
